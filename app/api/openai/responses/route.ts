...
import { ServerRateLimiter, InputValidator } from "@/app/lib/utils/api-helpers";
...
export async function POST(request: NextRequest) {
    try {
      ...
      const instructions: string = "You are a helpful assistant who knows general knowledge about the world. Keep your responses to one or two sentances, maximum.";
